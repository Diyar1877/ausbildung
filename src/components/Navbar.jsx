        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-1 flex justify-center space-x-8">
              <Link to="/" className={`${isActive('/') ? 'bg-gray-900 text-white' : 'text-gray-600'} px-3 py-2 rounded-md`} onClick={() => setIsMenuOpen(false)}>
                Home
              </Link>
              <Link to="/projects" className={`${isActive('/projects') ? 'bg-gray-900 text-white' : 'text-gray-600'} px-3 py-2 rounded-md`} onClick={() => setIsMenuOpen(false)}>
                Projekte
              </Link>
              <Link to="/about" className={`${isActive('/about') ? 'bg-gray-900 text-white' : 'text-gray-600'} px-3 py-2 rounded-md`} onClick={() => setIsMenuOpen(false)}>
                Über mich
              </Link>
              <Link to="/favorites" className={`${isActive('/favorites') ? 'bg-gray-900 text-white' : 'text-gray-600'} px-3 py-2 rounded-md`} onClick={() => setIsMenuOpen(false)}>
                Favoriten
              </Link>
              <Link to="/subjects" className={`${isActive('/subjects') ? 'bg-gray-900 text-white' : 'text-gray-600'} px-3 py-2 rounded-md`} onClick={() => setIsMenuOpen(false)}>
                Fächer
              </Link>
            </div>
